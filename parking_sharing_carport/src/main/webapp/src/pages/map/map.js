...
/* 浏览器定位函数 */ 
var map = new BMap.Map("BaiduMap"); // 地图对象 参数2：关闭地图POI点击事件
...
map.addControl(geolocationControl);
	...
	// 数据库中的车位对象的集合
	var carPortList = [ // 测试数据
		{
			"id": 1,
			"address": "四川省成都市青羊区人民东路天府广场B2层",
			"number": 1,
			"userBean": {
				"id": 1,
				"username": "root",
				...
				"phone": "12313123",
				"idcard": "456789456789781104",
				"email": "12313@qq.com",
				"job": "程序猿",
				"headImg": null
			},
			"certificate": "IMG_6579.PNG",
			"certificateNumber": "1231234234243",
			"status": "0"
		},
		{
			"id": 2,
			"address": "四川省成都市成华区二环路东二段29号SM广场F3",
			"number": 2,
			"userBean": {
				"id": 1,
				"username": "root",
				"realname": "root",
				"password": "123",
				"address": "四川省成都市成华区二环路东二段29号SM广场",
				"phone": "12313123",
				"idcard": "456789456789781104",
				"email": "12313@qq.com",
				"job": "程序猿",
			...
			"certificate": "IMG_6579.PNG",
			"certificateNumber": "234234324234",
			"status": "0"
		},
		{
			"id": 3,
			"address": "四川省成都市青羊区少城路8号汉庭酒店天府广场人民公园店",
			"number": 2,
			"userBean": {
				"id": 1,
				"username": "root",
	...
	// 点击图标进入详情页
	function goMessage(carPortId) {
		console.info(carPortId);
		router.load({ url: "pages/stall/detail/detail.html", param: {id:carPortId} });
		// window.location.href = "/carport.htmk?&id=" + carPortId;
	}
	
	// 获取数据库中的车位数据
//	function getCarPortList() {
//		$.ajax({
//			url: "/carport/status/0",
//			type: "post",
//			async: false,
...
//	}
	...
	function bdGEO() {
		var add = carPortList[index].address;
		if (add != null) {
			geocodeSearch(add);
		}
		index++;
		...
		myGeo.getPoint(add, function(point) {
			if (point) {
				...
				/*var mapLabel = new BMap.Label(
					"<div class='test_div' onclick='goMessage(1)'>" +
						"<table>" +
							"<tr><td>gaojishuxing</td></tr>" +
						"</table>" +
					"</div>", {offset: new BMap.Size(20, -10)});
				addMarker(address, mapLabel,carPortList[index].id);*/
				addMarker(address,carPortList[index].id);
			}
		}, "成都市");
	}
	...
	function addMarker(point,carPortId) {

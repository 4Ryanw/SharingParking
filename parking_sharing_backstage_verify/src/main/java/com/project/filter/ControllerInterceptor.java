...
public class ControllerInterceptor {
	...
	@Autowired
	private AdminHandler adminService;
    ...
    public void doAfterReturing(Object obj) {
        ...
        AdminBean admin = adminService.getAdmin();
        ...
        if (uri.indexOf("login")!=-1 || uri.indexOf("Login")!=-1) {
            ...
            if (admin!=null && admin.getA_name()!=null) {
            	bean.setL_userName(admin.getA_name());
        ...
        if (uri.indexOf("login")==-1 && uri.indexOf("find")==-1 && uri.indexOf("loginout")==-1 && uri.indexOf("logout")==-1 && uri.indexOf("error")==-1) {
        	...
        	if (admin!=null && admin.getA_name()!=null) {
            	...
            	dataBean.setDa_userName(admin.getA_name());
